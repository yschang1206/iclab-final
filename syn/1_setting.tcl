...
set_input_delay  [expr $TEST_CYCLE*0.4]  -clock clk [remove_from_collection [all_inputs] [get_ports clk]]
set_output_delay  [expr $TEST_CYCLE*0.4]  -clock clk   [all_outputs]
